...
FROM
    ...
    LEFT JOIN weenie_properties_int w_int_itemtype ON lb.weenie_Class_Id = w_int_itemtype.object_Id
    AND w_int_itemtype.type = 1
    LEFT JOIN weenie_properties_int w_int_uieffect ON lb.weenie_Class_Id = w_int_uieffect.object_Id AND w_int_uieffect.type = 18
    LEFT JOIN weenie_properties_int w_int_underlay ON lb.weenie_Class_Id = w_int_underlay.object_Id AND w_int_underlay.type = 52
